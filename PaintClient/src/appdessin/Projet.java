...
public class Projet {
    ...
    public ArrayList<ColoredCercle> getColoredCercles() {
        return ColoredCercles;
    }

    public void setColoredCercles(ArrayList<ColoredCercle> ColoredCercles) {
        this.ColoredCercles = ColoredCercles;
    }
